...
export function ObsidianSaveControl({ runtimeMode, filename, markdown, targetLabel, approved, entryType, category, destinationLabel }: Props) {
  ...
  const confirm = async () => {
    setConfirming(false);
    await save.save(filename, markdown, entryType, category);
  };
