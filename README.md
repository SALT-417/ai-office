...
- **リアル／ミニチュア表示**：既存の実写風オフィスと、CSS・Reactで構成した軽量な2.5Dミニチュアオフィスを切り替えられます。ミニチュアでは社員がモードと作業状態に応じて決められた地点を自律移動し、`prefers-reduced-motion`設定時は移動を抑制します。
