...
[GitHub Pages版](https://salt-417.github.io/ai-office/)は静的なデモ表示のみです。GitHub PagesはExpressやOllamaを実行しないため、依頼と成果物生成のボタンを無効にしています。既に使用中ブラウザへ保存された履歴の閲覧、承認、差し戻し、削除は利用できます。履歴がGitHubや外部サーバーへ送信されることはありません。5モード、社員選択、進捗変更など既存のデモ機能も引き続き操作できます。
